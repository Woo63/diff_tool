...
public:
    ...
    void setupUi(QMainWindow *MyWindow)
    {
        ...
        MyWindow->resize(670, 393);
        MyWindow->setMinimumSize(QSize(670, 393));
        MyWindow->setMaximumSize(QSize(670, 393));
        QPalette palette;
        ...
        MyWindow->setIconSize(QSize(26, 26));
        ...
        scrollArea->setMinimumSize(QSize(652, 343));
        QFont font;
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 650, 341));
        ...
        lb1->setFont(font);
        lb1->setStyleSheet(QStringLiteral("image:url(2.png);"));
        ...
        lb2->setFont(font);
        lb2->setStyleSheet(QStringLiteral("image:url(2.png);"));
        ...
        lb3->setPalette(palette4);
        QFont font1;
        font1.setPointSize(10);
        lb3->setFont(font1);
        lb3->setStyleSheet(QStringLiteral("image:url(2.png);"));
        ...
        lb4->setPalette(palette5);
        lb4->setFont(font1);
        lb4->setStyleSheet(QStringLiteral("image:url(2.png);"));
